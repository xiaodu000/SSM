		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${acitvity.name}</b> <small style="color: gray;">${remark.editFlag=='1'?remark.editTime:remark.createTime}由${remark.editFlag=='1'?remark.editBy:remark.createBy}${remark.editFlag=='1'?'创建':'修改'}</small>
